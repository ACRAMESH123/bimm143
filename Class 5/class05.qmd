...
All ggplot figure have at least 3 layers:
- data
- aesthetics (how the data maps to the plot)
- geometry (how we draw the plot)

Before I use any package i need t download and install iit with the `install.packages()` command.
...
Once a package is intalled I can load it up with the `library()` function.
